...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/system/info/getAllInfo", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/workdev/getFourWorkDev", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/workdev/getlist/**", "anon,captchaValidate");
